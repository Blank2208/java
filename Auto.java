...
public class Auto {
    ...
    // public Auto() - Konstruktoren koennen auch leer sein bzw. Konstruktoren koennen optional Argumente erhalten
    ...
    public static void main(String[] args) {
        ...
        Auto audi_a4 = new Auto("Audi", 2.0, 25); // Auto = Klassennamen; Auto hier als Datentyp
